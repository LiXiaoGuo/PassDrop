...
public class HttpInfoCatchInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        entity.setProtocol(protocol.toString());
        ...
        if (requestBody != null) {
            ...
            entity.setRequestContentLength(requestBody.contentLength());
            ...
            entity.setRequestBody(buffer.readString(charset));
        }
        //-----request prepare----
        ...
        entity.setTookMills(TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - startNs));
        ...
        entity.setResponseContentLength(responseBody.contentLength());
        if (response.body() != null) {
            ...
            if (contentType != null) {
                try {
                    ...
                    entity.setResponseBody("unreadable, charset error");
                }
            }
            if (isPlaintext(buffer) && responseBody.contentLength() != 0) {
                entity.setResponseBody(buffer.clone().readString(charset));
            }
            else {
                entity.setResponseBody("unreadable, not text");
            }
        }
