...
public abstract class BaseApplication extends Application {
    ...
    public static void exitApplication() {
        ...
        exitIntent.setAction(BaseActivity.Companion.getACTION_EXIT_APPLICATION());
    ...
    public static String getAppSignature() {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.d(TAG, "package name not found");
    ...
    private class FrameworkActivityLifeCycleCallback implements ActivityLifecycleCallbacks {
        ...
        public void onActivityCreated(Activity activity, Bundle bundle) {
            mActivityCount++;
            Log.e("BaseApplication", "当前activity的数量:" + mActivityCount + "");
        }
