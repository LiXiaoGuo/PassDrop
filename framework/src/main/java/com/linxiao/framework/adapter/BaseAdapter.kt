...
open class BaseAdapter<T, BD : ViewDataBinding>(@LayoutRes layoutId: Int, dataList: ArrayList<T>, isStandard: Boolean = true) : BaseRecyclerAdapter<T, BaseAdapter.Holder>(),ItemTouchHelperAdapter {
