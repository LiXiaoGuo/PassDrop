...
public class NotificationManager {
     ...
     */
    public static void sendSimpleNotification(@DrawableRes int icon,String title, String contentText, Intent targetActivityIntent) {
        SimpleNotificationBuilder builder = new SimpleNotificationBuilder(BaseApplication.getAppContext(),icon, title, contentText);
        builder.setTicker(contentText)
                .setLargeIcon(BitmapFactory.decodeResource(BaseApplication.getAppContext().getResources(), icon))
